...
readLayout.py
	Contains functions that help parse the layout .obj files of the houses. More important 
	functions include a function that returns the faces of the floor of each room in the
	house.
