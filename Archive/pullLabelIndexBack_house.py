...
import os
import shutil
import instance2classFromInfoLog

# output_dir = "/scratch/el216/output_scenenet/"
output_dir_temp = "/homes/el216/Workspace/OutputSceneNet"
house = sys.argv[1]
...
# for each room
house_path = os.path.join(output_dir_temp, house)
...
instance2classFromInfoLog.main(house)