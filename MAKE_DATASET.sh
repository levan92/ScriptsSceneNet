...
then
    ...
    echo 'Output files of house '$houseID' copied to /scratch/el216/output_scenenet/'$houseID | tee -a makedataset_logfile.log
    ...
    then
        ...
        cp -r /homes/el216/Workspace/OutputSceneNet/* /scratch/el216/output_scenenet/$houseID
        echo 'Output files of house '$houseID' overwritten to /scratch/el216/output_scenenet/'$houseID | tee -a makedataset_logfile.log
